load plot_analysis_training_M3_5_limonene_cntnap2_WT_reduced_set_first_day_background_high_concentration
...
hold on
a=plot(nanmean(performance_matrix(genotype_cntnap2_1_WT_0==1,:)),'m'), set(a,'LineWidth',3)
...
a=plot(nanmean(performance_matrix(genotype_cntnap2_1_WT_0==0,:)),'g'),set(a,'LineWidth',3)
