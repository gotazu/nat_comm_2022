load plot_analysis_training_M3_5_limonene_cntnap2_WT_reduced_set_first_day_second_pair
...
hold on
a=plot(nanmean(performance_matrix(genotype_cntnap2_1_WT_0==1,:)),'m'), set(a,'LineWidth',4)
...
a=plot(nanmean(performance_matrix(genotype_cntnap2_1_WT_0==0,:)),'g'),set(a,'LineWidth',4)
